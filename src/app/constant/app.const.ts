...
export const CLICK_TOPROOM = 'click link /top-room'
...
export const CLICK_INTRO = 'click link /introduction'
export const CLICK_CONTACT = 'click link /contact'
...
export const GUEST = "A guest with "
...
export const FEEDBACKNAME = 'Feedback'
export const FEEDBACKCLICK = 'feedback'
